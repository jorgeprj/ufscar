//Exercicio Proposto 32

/*
Uma pessoa tem suas características pessoais (peso, altura,...) e tem documentos 
(título de eleitor, RG, CPF,...)... Faça uma representação em C dos dados de uma pessoa. 
*/
